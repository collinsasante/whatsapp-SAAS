...
import { LayoutDashboard, Building2, CreditCard, LogOut, Settings, Shield, ChevronRight, Menu, X, Users, TrendingUp } from 'lucide-react';
...
const NAV = [
  ...
  { href: '/platform-admin/insights', label: 'Insights', icon: TrendingUp },
