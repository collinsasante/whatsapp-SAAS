...
function ChannelBadge({ channelType, whatsappNumberLabel }: { channelType?: string; whatsappNumberLabel?: string | null }) {
      ...
      <div className="border-b border-gray-100 dark:border-gray-700 flex-shrink-0 bg-white dark:bg-gray-900">
        <div className="flex items-center gap-3 px-4 py-3">
            ...
            <div className="relative flex-shrink-0">
              ...
              <ChannelBadge channelType={conversation.channel?.type} whatsappNumberLabel={conversation.whatsappNumber?.label} />
            </div>
            {/* Name + status + labels */}
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-1.5 flex-wrap">
                ...
                {conversation.whatsappNumber?.label && (
                  <span className="text-[10px] bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-700 px-1.5 py-0.5 rounded-full font-medium">
                    WhatsApp · {conversation.whatsappNumber.label}
                  </span>
                )}
