    ...
    >
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 flex flex-col min-h-0">
          <div ref={scrollContainerRef} className="flex-1 overflow-y-auto px-4 py-4 min-h-0" style={{ backgroundImage: 'url(/chat-bg.jpg)', backgroundSize: 'auto', backgroundRepeat: 'repeat', backgroundColor: '#f0ebe4', backgroundBlendMode: 'multiply' }}>
            {loading ? (
