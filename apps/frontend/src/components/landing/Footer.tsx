    ...
    <footer className="kp_footer">
      <div className="container">
        <div className="row g-4">
          ...
          <div className="col-lg-3 col-md-6">
            <Link href="/">
              ...
              <img src="/logo-white.svg" alt="VerzChat" className="ft_logo" />
            </Link>
            <p className="ft_tagline">
              The WhatsApp inbox built for teams that take customer communication seriously.
            </p>
            <div className="live_dot mb-3">
              <span className="dot" />
        ...
        <div className="ft_bottom">
          <p>© {new Date().getFullYear()} VerzChat. Built for teams that move fast.</p>
          <p>
            Questions?{' '}
            <a href="mailto:support@verzchat.com">support@verzchat.com</a>
          </p>
        </div>
      </div>
    </footer>
