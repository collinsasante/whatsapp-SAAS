...
export class AttributesController {
  ...
  @Post()
  create(@CurrentUser() u: JwtPayload, @Body() body: CreateAttributeDto) {
    return this.service.create(u.tenantId, body);
  }

  @Patch(':id')
  update(@CurrentUser() u: JwtPayload, @Param('id') id: string, @Body() body: Partial<CreateAttributeDto>) {
